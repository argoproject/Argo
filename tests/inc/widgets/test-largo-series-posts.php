...
class SeriesPostsWidgetTestFunctions extends WP_UnitTestCase {
	...
	function test_enabled_widget() {
		...
		unregister_widget('largo_series_posts_widget');
		...
		$this->assertFalse( array_key_exists('largo_series_posts_widget',$wp_widget_factory->widgets) );
