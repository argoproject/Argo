...
class HelpersTestFunctions extends WP_UnitTestCase {
	...
	function test_largo_twitter_url_to_username() {
		 ...
		 */
		$result = largo_twitter_url_to_username("http://twitter.com/foo_1");
		$this->assertEquals("foo_1", $result)
		unset($result);
		
		$result = largo_twitter_url_to_username("https://twitter.com/foo_1");
		$this->assertEquals("foo_1", $result)
		unset($result);
		
		$result = largo_twitter_url_to_username("https://www.twitter.com/foo_1");
		$this->assertEquals("foo_1", $result)
		unset($result);
		 ...
		 */
		$result = largo_twitter_url_to_username("http://twitter.com/@foo.bar_14-0?baz=qux&yes=no#hi");
		$this->assertEquals("foo.bar_14-!0", $result)
		unset($result);
		
		$result = largo_twitter_url_to_username("https://twitter.com/@foo.bar_14-!0?baz=qux&yes=no#hi");
		$this->assertEquals("foo.bar_14-!0", $result)
		unset($result);
		 ...
		 */
		$result = largo_twitter_url_to_username("http://github.com/INN/Largo");
		$this->assertEquals("Largo", $result)
		unset($result);
		
		$result = largo_twitter_url_to_username("https://plus.google.com/Largo");
		$this->assertEquals("Largo", $result)
		unset($result);
