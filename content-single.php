			...
			<div id="rp<?php echo $count; ?>">  
				...
				<ul>
					...
					<li class="top-related clearfix">
						...
						<?php } ?>
						<p><?php echo argo_get_excerpt( $top_post ); ?> <a href="<?php echo get_permalink( $top_post->ID ); ?>" title="<?php echo esc_attr($topic->name); ?>" title="<?php echo esc_attr($topic->name); ?>"><b>Read More</b></a></p>
					</li>
